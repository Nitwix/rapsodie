    ...
    <div class="container" > <!-- collapses the navbar when the 'content' is clicked-->
        ...
        <div class="row">
            <div class="col-xs-12 text-justify">
                ...
                <h3 class="styled_text">De l’œuvre comme livret</h3>
                <h4 class="styled_text">
